...
//  { "jog","jogc",_f0, 0, tx_print_nul, get_nul, cm_run_jogc, (float *)&cm.jogging_dest, 0},
    ...
    { "1","1tr",_fipt,4, st_print_tr, st_get_tr, st_set_tr, (float *)&st_cfg.mot[MOTOR_1].travel_rev,     M1_TRAVEL_PER_REV },
    { "1","1mi",_fip, 0, st_print_mi, get_ui8, st_set_mi,   (float *)&st_cfg.mot[MOTOR_1].microsteps,     M1_MICROSTEPS },
    { "1","1su",_fips,5, st_print_su, st_get_su, st_set_su, (float *)&st_cfg.mot[MOTOR_1].steps_per_unit, M1_STEPS_PER_UNIT },
...
//  { "1","1mt",_fip, 2, st_print_mt, get_flt, st_set_mt,   (float *)&st_cfg.mot[MOTOR_1].motor_timeout,  M1_MOTOR_TIMEOUT },
    ...
    { "2","2tr",_fipt,4, st_print_tr, st_get_tr, st_set_tr, (float *)&st_cfg.mot[MOTOR_2].travel_rev,     M2_TRAVEL_PER_REV },
    { "2","2mi",_fip, 0, st_print_mi, get_ui8, st_set_mi,   (float *)&st_cfg.mot[MOTOR_2].microsteps,     M2_MICROSTEPS },
    { "2","2su",_fips,5, st_print_su, st_get_su, st_set_su, (float *)&st_cfg.mot[MOTOR_2].steps_per_unit, M2_STEPS_PER_UNIT },
...
//  { "2","2mt",_fip, 2, st_print_mt, get_flt, st_set_mt,   (float *)&st_cfg.mot[MOTOR_2].motor_timeout,  M2_MOTOR_TIMEOUT },
    ...
    { "3","3tr",_fipt,4, st_print_tr, st_get_tr, st_set_tr, (float *)&st_cfg.mot[MOTOR_3].travel_rev,     M3_TRAVEL_PER_REV },
    { "3","3mi",_fip, 0, st_print_mi, get_ui8, st_set_mi,   (float *)&st_cfg.mot[MOTOR_3].microsteps,     M3_MICROSTEPS },
    { "3","3su",_fips,5, st_print_su, st_get_su, st_set_su, (float *)&st_cfg.mot[MOTOR_3].steps_per_unit, M3_STEPS_PER_UNIT },
...
//  { "3","3mt",_fip, 2, st_print_mt, get_flt, st_set_mt,   (float *)&st_cfg.mot[MOTOR_3].motor_timeout,  M3_MOTOR_TIMEOUT },
    ...
    { "4","4tr",_fipt,4, st_print_tr, st_get_tr, st_set_tr, (float *)&st_cfg.mot[MOTOR_4].travel_rev,     M4_TRAVEL_PER_REV },
    { "4","4mi",_fip, 0, st_print_mi, get_ui8, st_set_mi,   (float *)&st_cfg.mot[MOTOR_4].microsteps,     M4_MICROSTEPS },
    { "4","4su",_fips,5, st_print_su, st_get_su, st_set_su, (float *)&st_cfg.mot[MOTOR_4].steps_per_unit, M4_STEPS_PER_UNIT },
...
//  { "6","6mt",_fip, 2, st_print_mt, get_flt, st_set_mt,   (float *)&st_cfg.mot[MOTOR_6].motor_timeout,  M6_MOTOR_TIMEOUT },
    ...
    { "sys","ct", _fipnc,4, cm_print_ct,  get_flt, cm_set_ct,(float *)&cm.chordal_tolerance,        CHORDAL_TOLERANCE },
    ...
    { "",   "spe", _f0,  0, cm_print_spe, get_ui8, set_ro,   (float *)&spindle.enable, 0 },         // get spindle enable
    { "",   "spd", _f0,  0, cm_print_spd, get_ui8,cm_set_dir,(float *)&spindle.direction, 0 },      // get spindle direction
    { "",   "sps", _f0,  0, cm_print_sps, get_flt, set_ro,   (float *)&spindle.speed, 0 },          // get spindle speed
    ...
    { "",   "com", _f0,  0, cm_print_com, get_ui8, set_ro,   (float *)&coolant.mist_enable, 0 },    // get mist coolant enable
    { "",   "cof", _f0,  0, cm_print_cof, get_ui8, set_ro,   (float *)&coolant.flood_enable, 0 },   // get flood coolant enable
    ...
    { "", "er",  _f0, 0, tx_print_nul, rpt_er,    set_ro,    (float *)&cs.null, 0 },    // get bogus exception report for testing
    ...
    { "", "tick", _f0,0, tx_print_int, get_tick,  set_ro,    (float *)&cs.null, 0 },    // get system time tic
    ...
    { "", "help",_f0, 0, tx_print_nul, help_config, set_ro,  (float *)&cs.null,0 }, // prints config help screen
    { "", "h",   _f0, 0, tx_print_nul, help_config, set_ro,  (float *)&cs.null,0 }, // alias for "help"
#endif
...
#define NV_COUNT_UBER_GROUPS 6
    ...
    { "", "m", _f0, 0, tx_print_nul, _do_motors, set_ro, (float *)&cs.null,0 },
    { "", "q", _f0, 0, tx_print_nul, _do_axes,   set_ro, (float *)&cs.null,0 },
    { "", "o", _f0, 0, tx_print_nul, _do_offsets,set_ro, (float *)&cs.null,0 },
    { "", "di", _f0, 0, tx_print_nul,_do_inputs, set_ro, (float *)&cs.null,0 },
    { "", "do", _f0, 0, tx_print_nul,_do_outputs,set_ro, (float *)&cs.null,0 },
    { "", "$", _f0, 0, tx_print_nul, _do_all,    set_ro, (float *)&cs.null,0 }
};
...
void preprocess_float(nvObj_t *nv)
{
    ...
    if (GET_TABLE_BYTE(flags) & F_SU_SPECIAL) {  // special handling for SU
        if (cm_get_units_mode(MODEL) == INCHES) {
            if (st_axis_is_linear(nv)) {
    ...
    if (GET_TABLE_BYTE(flags) & F_TR_SPECIAL) {  // special handling for TR
        if (cm_get_units_mode(MODEL) == INCHES) {
            if (st_axis_is_linear(nv)) {
...
/*
 * nv_get_integer_from_token() - get the number of any object from it's token
 * 
 * Hack to return an integer if present in token field. Cannot have -, + or . (just ints)
 */

int8_t nv_get_integer_from_token(const index_t index)
{
    char tmp[TOKEN_LEN+1];
    char *p = tmp;
    strcpy(tmp, cfgArray[index].token);     // assumes a NUL terminated string is copied
