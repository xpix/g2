...
#define INIT_MESSAGE "Initializing configs to CNC3040 settings"
...
#define X_TRAVEL_MAX                300                     // xtm  maximum travel - used by soft limits and homing
...
#define P1_PWM_FREQUENCY            20000             // in Hz
#define P1_CW_SPEED_LO              1000            // in RPM (arbitrary units)
#define P1_CW_SPEED_HI              12000
#define P1_CW_PHASE_LO              0.050           // phase [0..1]
#define P1_CW_PHASE_HI              0.995
#define P1_CCW_SPEED_LO             1000
#define P1_CCW_SPEED_HI             12000
#define P1_CCW_PHASE_LO             0.050
#define P1_CCW_PHASE_HI             0.995
...
#define G59_X_OFFSET -207.320
#define G59_Y_OFFSET 74.800
#define G59_Z_OFFSET -43.000
